...
def compress_video(input_path: Path, output_path: Path, quality: str = "medium") -> VideoProcessingResponse:
    """
...
def convert_video(input_path: Path, output_path: Path, output_format: str, quality: str = "medium") -> VideoProcessingResponse:
    """
