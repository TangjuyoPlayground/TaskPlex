...
def compress_image(input_path: Path, output_path: Path, quality: str = "medium") -> ImageProcessingResponse:
    """
    ...
    try:
        ...
        with Image.open(input_path) as img:
            ...
            # Get quality value
            quality_value = IMAGE_COMPRESSION_QUALITY.get(quality, IMAGE_COMPRESSION_QUALITY["medium"])
...
def convert_image(input_path: Path, output_path: Path, output_format: str, quality: str = "medium") -> ImageProcessingResponse:
    """
    ...
    try:
        ...
        with Image.open(input_path) as img:
            ...
            if output_format.lower() in ['jpg', 'jpeg', 'webp']:
                img.save(output_path, format=pillow_format, quality=quality_value, optimize=True)
            else:
