...
def split_pdf(input_path: Path, output_dir: Path, pages: Optional[List[int]] = None, 
              page_ranges: Optional[List[str]] = None) -> PDFProcessingResponse:
    """
...
def reorganize_pdf(input_path: Path, output_path: Path, page_order: List[int]) -> PDFProcessingResponse:
    """
