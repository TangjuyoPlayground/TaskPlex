...
const FlipImageScreen = createLazyComponent(() => import('./pages/FlipImageScreen'), 'FlipImageScreen');
const ImageToIconScreen = createLazyComponent(() => import('./pages/ImageToIconScreen'), 'ImageToIconScreen');
...
const FileEncryptionScreen = createLazyComponent(() => import('./pages/FileEncryptionScreen'), 'FileEncryptionScreen');
...
const AudioMergeScreen = createLazyComponent(() => import('./pages/AudioMergeScreen'), 'AudioMergeScreen');
const AudioMetadataScreen = createLazyComponent(() => import('./pages/AudioMetadataScreen'), 'AudioMetadataScreen');
...
const PDFToImages = createLazyComponent(() => import('./pages/pdf/PDFToImagesScreen'), 'PDFToImagesScreen');
const ImagesToPDF = createLazyComponent(() => import('./pages/pdf/ImagesToPDFScreen'), 'ImagesToPDFScreen');
...
const componentMap: Record<string, React.LazyExoticComponent<React.ComponentType<Record<string, unknown>>>> = {
  ...
  'audio-merge': AudioMergeScreen,
  'audio-metadata': AudioMetadataScreen,
  ...
  'image-flip': FlipImageScreen,
  'image-to-icon': ImageToIconScreen,
  ...
  'file-encryption': FileEncryptionScreen,
